...
exports.QueryEnquiryDto = void 0;
const class_validator_1 = require("class-validator");
const pagination_query_dto_1 = require("../../../common/dto/pagination-query.dto");
const enquiry_schema_1 = require("../schemas/enquiry.schema");
class QueryEnquiryDto extends pagination_query_dto_1.PaginationQueryDto {
    status;
    source;
    category;
}
...
__decorate([
    ...
    __metadata("design:type", String)
], QueryEnquiryDto.prototype, "source", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsMongoId)(),
    __metadata("design:type", String)
], QueryEnquiryDto.prototype, "category", void 0);
