...
let BannersController = class BannersController {
    ...
    findAll(placement) {
        if (!placement || !Object.values(banner_schema_1.BannerPlacement).includes(placement)) {
            throw new common_1.BadRequestException(`A valid "placement" query param is required (one of: ${Object.values(banner_schema_1.BannerPlacement).join(', ')})`);
        }
